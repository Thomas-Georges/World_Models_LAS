...
Claude (Anthropic) in the \texttt{wm-prediction} repository. Track~I code:
...
\texttt{wm-prediction} repository, which were built to probe exactly those two
...
\begin{figure}[h]
\centering
\begin{minipage}{0.49\linewidth}\includegraphics[width=\linewidth]{r2dreamer_target_eval_curve.png}\end{minipage}\hfill
\begin{minipage}{0.49\linewidth}\includegraphics[width=\linewidth]{r2dreamer_finetune_advantage.png}\end{minipage}
...
\begin{figure}[h]
\centering
\begin{minipage}{0.46\linewidth}\includegraphics[width=\linewidth]{r2dreamer_training_episode.png}\end{minipage}\hfill
\begin{minipage}{0.52\linewidth}\includegraphics[width=\linewidth]{r2dreamer_diagnostics.png}\end{minipage}
...
\begin{figure}[h]
\centering
\begin{minipage}{0.42\linewidth}\includegraphics[width=\linewidth]{r2dreamer_latent_pca_2d.png}\end{minipage}\hfill
\begin{minipage}{0.55\linewidth}\includegraphics[width=\linewidth]{r2dreamer_latent_pca_3d.png}\end{minipage}
...
\begin{figure}[h]
\centering
\begin{minipage}{0.62\linewidth}\includegraphics[width=\linewidth]{pointmaze_training_curves.png}\end{minipage}\hfill
\begin{minipage}{0.36\linewidth}\includegraphics[width=\linewidth]{pointmaze_scratch_vs_finetune.png}\end{minipage}
...
\begin{figure}[h]
\centering
\begin{minipage}{0.33\linewidth}\includegraphics[width=\linewidth]{cem_success.pdf}\end{minipage}\hfill
\begin{minipage}{0.33\linewidth}\includegraphics[width=\linewidth]{cem_state_dist.pdf}\end{minipage}\hfill
\begin{minipage}{0.33\linewidth}\includegraphics[width=\linewidth]{cem_embed_div.pdf}\end{minipage}
...
{\sloppy
Code lives in the \texttt{wm-prediction} repository. \textbf{Track~I:}
